...
**Amazon EMR _Elastic MapReduce_**
  ...
  * EMR Notebooks
  ...
  ```
  * [Spark](https://docs.aws.amazon.com/emr/latest/ReleaseGuide/emr-spark.html) Components that runs on top of _spark core_
...
## GCP - Professional Machin* e Learning Engineer
