...
* API Access
  ...
  * `GetRecommendations` (Recommended products, content, etc - similar itens)
  * `GetPersonalizedRanking` (Rank a list of items, allows editorial control/curation)
...
```
  ...
  * Merge/join Data, we can use pandas to marge two data frames `df.merge(<df_1>, on=<key>, how = <'inner'> )` 
...
* Resources : 
  ...
  * [AWS Cloud Adoption Framework](https://d1.awsstatic.com/whitepapers/AWS_CAF_Security_Perspective.pdf)
  * [Model of responsibility](https://aws.amazon.com/pt/compliance/shared-responsibility-model/)
...
* Resources : 
  ...
  * [AWS Services per Refion](https://aws.amazon.com/pt/about-aws/global-infrastructure/regions_az/?p=ngi&loc=2)
  * [AWS Global Infrastructure](https://aws.amazon.com/pt/about-aws/global-infrastructure/)
  * [Sustainability in the Cloud](https://sustainability.aboutamazon.com/environment/the-cloud)


<br>

[Data Center](https://aws.amazon.com/pt/compliance/data-center/controls/) Security
...
* Resources 
  ...
  * [AWS Compliance Programs](https://aws.amazon.com/pt/compliance/programs/)
  * [AWS Compliance Center](https://aws.amazon.com/pt/financial-services/security-compliance/compliance-center/)
  * [Compliance Best Practices and Workbooks](https://aws.amazon.com/pt/compliance/resources/)
...
* **Network ACLs** : A layer of security within yoru VPC. A Network access control list (_ACL_) is an optional layer of security that acts as a firewall for controlling traffic at the subnet level
...
[AWS Well-Architected Tool](https://us-east-1.console.aws.amazon.com/wellarchitected?region=us-east-1#) is a self-service tool that is designed to help customers review AWS workloads at any time.
...
[Expore](github.com/awslabs/amazon-sagemaker-examples/tree/master/hyperparameter_tuning)
 - __Targeting Direct Marketing with Amazon SageMaker XGBoost_
...
Operationalization : 
  ...
  5. **Deploy** : Deploy the application, the model, and the framework on a platform
...
_NEO_
  ...
  2. NEO convert the functions and operations in non-specific functions and operations

  3. NEO perform several optimization (_2x faster_)
...
_Building and Training ML Models using SageMaker and Spark_
...
* SageMaker-Spark SDK (_Scala and Python_)
...
_Building ML pipelines using SageMaker and Spark_
...
How **Rondom Cut** works ? 
  ...
  - A point is an _anomaly_ if its insertion greatly increases the tree size
...
One of the core benefits of a data lake solution is the ability to quickly and easily ingest multiple types of data
  ...
  * Service can help on this process _GLUE_
...
[Test Data Engineering](https://amazonmr.au1.qualtrics.com/jfe/form/SV_dg3duwjYBh3zZnn)
...
* Sanitize and prepare data for modeling
  ...
  * Perform data cleaning (_Sanitize_)
...
[Test Exploratory and data analysis](https://amazonmr.au1.qualtrics.com/jfe/form/SV_d9W72HMVJckXsUJ)
...
[Test Modeling](https://amazonmr.au1.qualtrics.com/jfe/form/SV_cOds6iMP7ekliD3)
...
[Test ML Implementation and Operations](https://amazonmr.au1.qualtrics.com/jfe/form/SV_1KOjszCqxc6qrl3)



[Study Questions : ](https://amazonmr.au1.qualtrics.com/jfe/form/SV_2nt0z0Far6DzAwJ)
