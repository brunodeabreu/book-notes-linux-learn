...
* Row Vectors, `1 x n`       [1  0  -1  2]
* n-Dimensional, 2D is a matrix `m x n`

In Machine Learning we usually work with 2D objects **m x n** matrix

```{r, echo = FALSE, out.width="90%"}
knitr::include_graphics("img/mxn_matrix_aws_math.png")
```
...
* Operations
  ...
  * Addition : Element wise addition if the vectors/matrix are the same length, (_adding the number of the same position_)
...
* Measures of Magnitude
  ...
  * **Norm** : How we measure of distance (_one vector to the other_)
  
    * Properties : 
    
      1: All distances are non-negative
      
      2: Distances multiply with scalar multiplication
      
      3: Triangle equality , If I travel from A to B then B to C, that is at least as far as going from A to C
      
    * Type of Norms
    
      * Euclidean Norm 
      * L1 Norm : `np.linalg.norm(<vector>, ord = 1)`
      * L2 Norm : `np.linalg.norm(<vector>, ord = 2)`
